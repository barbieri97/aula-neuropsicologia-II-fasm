# Banco de questões · Aula 03 — Saúde mental e envelhecimento
...
| # | Tipo | Nível | Tema |
|---|---|---|---|
| 1 | Múltipla escolha | muito fácil | Rastreio × diagnóstico |
| 2 | Verdadeiro ou falso | muito fácil | Depressão sem tristeza |
...
| 10 | Múltipla escolha | difícil | Diferencial depressão × TNC |
| 11 | Estudo de caso | difícil | Transtorno bipolar no idoso |
| 12 | ENADE/ENEM | difícil | Sensibilidade, especificidade e ponto de corte |
| 13 | Afirmações corretas | difícil | Psicose de início tardio e muito tardio |
| 14 | Múltipla escolha | difícil | Perfil estático × neurodegeneração |
| 15 | Verdadeiro ou falso | difícil | Psicofármacos e desempenho em testes |
| 16 | Estudo de caso | muito difícil | Rastreio negativo que não encerra a investigação |
| 17 | Múltipla escolha | muito difícil | Limites da GDS na presença de déficit cognitivo |
| 18 | ENADE/ENEM | muito difícil | Integração — psicose tardia × TNC |

---

## Questão 1 · múltipla escolha · muito fácil
**Objetivo** fixar a diferença entre rastrear e diagnosticar.
...
**Objetivo** reconhecer a apresentação atípica do quadro depressivo no idoso.

Julgue como **verdadeira (V)** ou **falsa (F)**.

| | Afirmação | V/F |
|---|---|---|
| I | No idoso, queixas somáticas inespecíficas, sintomas ansiosos, queixa de memória e irritabilidade podem ocupar o lugar da tristeza relatada. | |
| II | Se o paciente nega tristeza quando perguntado diretamente, o diagnóstico de episódio depressivo maior está descartado. | |
| III | Anti-hipertensivos, antiparkinsonianos e corticosteroides estão entre os fármacos associados a quadros depressivos. | |
| IV | A depressão é um dos transtornos psiquiátricos mais prevalentes em hospitais gerais e um dos mais subdiagnosticados na atenção primária. | |

<details>
<summary>Gabarito e comentário</summary>

**I — V.** É a chamada "depressão sem tristeza".

**II — F.** É o erro mais comum na prática. O critério nuclear se satisfaz com humor deprimido **ou** anedonia — perda de interesse ou prazer. Negar tristeza não descarta nada.

**III — V.** Somam-se a eles benzodiazepínicos, e vale distinguir isso da **carga anticolinérgica**, que não produz depressão mas rebaixa o desempenho nos testes.
...
**Objetivo** nomear os obstáculos entre o quadro e o diagnóstico.

Considere as afirmações sobre os filtros que se interpõem entre o transtorno psiquiátrico que o idoso de fato tem e o diagnóstico que ele recebe:

**I.** **Apresentação atípica** — o quadro se manifesta por queixas que não são as esperadas no adulto jovem.
**II.** **Comorbidade clínica** — insônia, dor, perda de apetite e fadiga têm várias causas simultâneas, e o sintoma é creditado à doença de base, não ao humor.
**III.** **Iatrogenia** — o próprio cuidado em saúde produz o quadro, seja por fármacos que induzem depressão, seja por fármacos que rebaixam o desempenho cognitivo.
**IV.** **Subdiagnóstico** — casos deixam de ser identificados e tratados, inclusive dentro do hospital, onde a prevalência é maior.
**V.** Quando o encaminhamento traz hipótese de demência, a investigação de humor pode ser dispensada.
...
**Objetivo** identificar o filtro da comorbidade clínica.

> **Sr. Jurandir, 78 anos, insuficiência cardíaca em acompanhamento há seis anos.**
> **História de vida.** Motorista de caminhão aposentado, casado, três filhos. Sempre foi "o que resolve tudo" na família.
> **Queixa.** Procura o clínico com cansaço, insônia e dores difusas há três meses. Nega tristeza quando perguntado diretamente. Deixou de ir à pescaria mensal com os amigos, "porque não tenho mais paciência".
> **Conduta do serviço.** Os sintomas foram atribuídos à insuficiência cardíaca e o diurético foi ajustado.
...
## Questão 5 · múltipla escolha · médio
**Objetivo** entender a decisão de projeto da GDS.
...
**Dois itens ainda tangenciam o somático** e merecem atenção na leitura de uma ficha:
- o item sobre **problemas de memória**, que pontua igual em quem está deprimido e em quem tem déficit cognitivo verdadeiro — e infla o escore em amostras de clínica de memória;
- o item sobre **estar cheio de energia**, que doença pulmonar, cardíaca ou anemia derrubam sozinhas.

Outras características de projeto: resposta dicotômica (sim/não, sem gradação), perguntas curtas, e alternância entre itens redigidos em sentido positivo e negativo, para quebrar padrão automático de resposta.
</details>
...
> **Os oito meses desde a viuvez.** O marido morreu de infarto em casa, à noite, ao lado dela. Parou a igreja no quarto mês; não sai de casa há três. Acorda às 3h e não volta a dormir; perdeu 6 kg. Diz "não sirvo mais para nada" e "se Deus me levasse, não reclamava". A filha relata perguntas repetidas e duas consultas esquecidas.
> **Avaliação.** Funções cognitivas preservadas para idade e escolaridade. Vígil, orientada, colaborativa, com latência de resposta aumentada. Responde "não sei" com frequência e acerta quando encorajada a tentar. Exames clínicos recentes afastaram causa orgânica. Em uso de hidroclorotiazida e losartana; nenhum psicotrópico.
> **GDS-15**, aplicada por entrevistadora treinada, com a filha fora da sala:

| Item | Resposta | Item | Resposta |
|---|---|---|---|
| 1. Satisfeita com a vida? | Não | 9. Prefere ficar em casa? | Não |
| 2. Interrompeu atividades? | Sim | 10. Mais problemas de memória? | Não |
| 3. Acha a vida vazia? | Sim | 11. Maravilhoso estar viva? | Sim |
| 4. Aborrece-se com frequência? | Sim | 12. Vale a pena viver assim? | Sim |
| 5. De bem com a vida? | Sim | 13. Cheia de energia? | Não |
| 6. Teme que algo ruim aconteça? | Sim | 14. Situação tem solução? | Sim |
...
**Objetivo** compreender a depressão de início tardio e seu substrato.

Julgue como **verdadeira (V)** ou **falsa (F)**.

| | Afirmação | V/F |
|---|---|---|
| I | A hipótese da depressão vascular associa o quadro depressivo geriátrico a doença isquêmica subcortical silenciosa. | |
| II | Nos quadros de início tardio, espera-se um perfil **amnéstico**, com falha de armazenamento semelhante à da doença de Alzheimer. | |
| III | Hiperintensidades de substância branca são mais frequentes em idosos deprimidos, e o início tardio se associa a alteração cognitiva mais proeminente e a menor história familiar de depressão. | |
| IV | A lesão que interessa nesse quadro não está no córtex, mas nas conexões que ligam o pré-frontal ao estriado. | |
...
**II — F.** O perfil esperado é **disexecutivo**: lentificação, perda de iniciativa, prejuízo de planejamento e de flexibilidade, com armazenamento relativamente preservado — e memória que **melhora com pista**. O perfil amnéstico, sem benefício de pista, é o da doença de Alzheimer.

**III — V.** E o contraste vale guardar: início tardio associa-se a comprometimento clínico; início precoce, a comorbidade psiquiátrica.

**IV — V.** É a alça frontoestriatal (pré-frontal dorsolateral → caudado → globo pálido → tálamo → de volta ao pré-frontal). A doença de pequenos vasos interrompe o circuito em pontos que a atrofia cortical não atingiria — daí o perfil de síndrome frontal.
</details>

---

## Questão 8 · afirmações corretas · médio
**Objetivo** descrever o que se espera na folha de respostas de um idoso deprimido.

Sobre as alterações cognitivas esperadas na depressão do idoso, considere:

**I.** Atenção sustentada e dividida, velocidade psicomotora e funções executivas estão entre os domínios afetados.
**II.** O desempenho de memória melhora com pista e com reconhecimento, e a curva de aprendizagem tende a ser achatada, sem esquecimento acelerado.
**III.** Predominam erros de omissão e respostas "não sei", com esforço variável ao longo da sessão.
**IV.** Déficits cognitivos são complicação eventual do quadro depressivo, e não característica dele.
**V.** Idosos deprimidos com alterações frontais têm maior chance de evoluir para quadro demencial, e o número de episódios ao longo da vida aumenta essa chance.
...
O item V é o que impede a leitura tranquilizadora do quadro. Idosos deprimidos com sintomas demenciais aparentemente reversíveis, acompanhados por cerca de três anos, apresentaram risco de demência irreversível bem superior ao de deprimidos sem sintomas cognitivos. É por isso que **tratar e reavaliar** é conduta, e não excesso de zelo.
</details>

---

## Questão 9 · ENADE/ENEM · médio
**Objetivo** entender por que estimativas de prevalência variam tanto.

> Estimativas de prevalência de quadros depressivos em idosos residentes na comunidade, segundo a definição de caso adotada:

| Definição de caso | Prevalência |
|---|---|
| Depressão maior (entrevista diagnóstica) — internacional | 1,8% |
| Depressão maior (entrevista diagnóstica) — Brasil | 7,0% |
| Distimia — Brasil | 3,3% |
| Depressão menor (2 a 5 sintomas, com prejuízo) — internacional | 9,8% |
| Sintomatologia significativa (escala de rastreio) — internacional | 13,5% |
| Sintomatologia significativa (escala de rastreio) — Brasil | 26,0% |
| Sintomas depressivos por rastreio — estudo de Bambuí | 38,5% |
...
Antes de comparar dois números de prevalência, é preciso perguntar **como cada estudo definiu caso**. Rastreio positivo não é diagnóstico, e "depressão menor" (2 a 5 sintomas, com prejuízo, sem fechar critério) sequer é categoria oficial do DSM-5-TR.
...
## Questão 10 · múltipla escolha · difícil
**Objetivo** operar o fluxo de decisão diante de queixa cognitiva com humor alterado.
...
Elementos que orientam a leitura enquanto a reavaliação não chega:

| Aponta para depressão | Aponta para transtorno neurocognitivo |
|---|---|
| instalação em semanas, com data reconhecível | instalação insidiosa, ao longo de meses |
| queixa trazida pelo próprio paciente, enfática | queixa trazida pelo acompanhante |
| responde "não sei" e desiste da tarefa | tenta, erra por aproximação, confabula |
| desempenho melhora com pista e reconhecimento | pista não melhora o desempenho |
| alteração do humor precede a do desempenho | declínio funcional precede a alteração do humor |
| consciência preservada do próprio déficit | minimiza ou desconhece o déficit (anosognosia) |

**Sobre "pseudodemência":** o termo é desaconselhado hoje. Ele sugere quadro falso, quando o prejuízo é real e mensurável — e parte desses casos evolui para demência.
</details>

---

## Questão 11 · estudo de caso · difícil
**Objetivo** integrar transtorno bipolar, fármacos e queixa cognitiva.

> **Sr. Elpídio, 72 anos, 11 anos de escolaridade.**
> **História de vida.** Comerciante aposentado, casado, dois filhos. Primeiro episódio depressivo aos 54 anos, tratado com antidepressivo por anos e classificado como depressão unipolar. Aos 70 anos apresentou quadro de irritabilidade intensa, redução da necessidade de sono, aumento de atividade e compras impulsivas que comprometeram a poupança do casal — episódio que levou ao diagnóstico de transtorno bipolar e à introdução de estabilizador.
> **Situação atual.** Em eutimia há 14 meses, segundo o psiquiatra. Traz queixa de "memória fraca" e de lentidão. Em uso de lítio, um antipsicótico em dose baixa, oxibutinina para bexiga hiperativa e um anti-histamínico de primeira geração para alergia.
> **Testagem.** Lentificação, prejuízo de memória verbal e de funções executivas; teste do relógio alterado; memória que melhora com pista.
...
**Objetivo** escolher um ponto de corte a partir da consequência do erro.

> Desempenho da GDS-15 em 302 idosos de ambulatório geral no Rio de Janeiro, tendo como padrão de referência a entrevista de geriatra apoiada em entrevista estruturada, cega ao resultado da escala. A área sob a curva ROC foi de 0,85 (IC 95% 0,79–0,91); 16,9% da amostra tinha transtorno de humor.
...
- **especificidade** — proporção de quem não tem a condição que o teste libera; especificidade alta significa **menos falso-positivo**;
- **AUC** — 0,5 equivale ao acaso e 1,0 à discriminação perfeita.
...
## Questão 13 · afirmações corretas · difícil
**Objetivo** organizar a nomenclatura e os fatores dos quadros psicóticos tardios.

Sobre os transtornos psicóticos de início tardio no idoso, considere:

**I.** Convenciona-se chamar de **início precoce** o que começa antes dos 40 anos; de **esquizofrenia de início tardio**, entre 40 e 60; e de **psicose esquizofreniforme de início muito tardio**, após os 60.
**II.** Esses cortes são convenção operacional, adotada para tornar comparáveis estudos que antes misturavam populações muito diferentes — não são fronteiras biológicas.
**III.** Há predomínio feminino marcado nos quadros de início tardio, e menor participação de fatores genéticos do que no início precoce.
**IV.** Isolamento social, ausência de parceiro ou de filhos, menor renda e condição de migrante estão entre os fatores associados.
**V.** No idoso, a maior parte dos quadros psicóticos é esquizofrenia primária, e a investigação de causas secundárias é dispensável.
...
**Um fator que costuma passar despercebido e é acionável:** privação sensorial. Perda auditiva e visual não corrigidas estão entre os fatores mais consistentes na psicose de início muito tardio — parte do manejo é sensorial e social, não farmacológica.
</details>

---

## Questão 14 · múltipla escolha · difícil
**Objetivo** distinguir comprometimento estático de neurodegeneração.
...
**Objetivo** considerar o efeito do tratamento sobre a medida.

Julgue como **verdadeira (V)** ou **falsa (F)**.

| | Afirmação | V/F |
|---|---|---|
| I | Em ensaio randomizado com pacientes com doença de Alzheimer, antipsicóticos atípicos produziram, em 36 semanas, piora cognitiva equivalente a cerca de um ano de deterioração, em comparação com placebo. | |
| II | O efeito sobre a cognição é homogêneo dentro da classe dos antipsicóticos, bastando registrar no laudo "em uso de antipsicótico". | |
| III | Polifarmácia psicotrópica — dois ou mais psicotrópicos simultâneos — associa-se a declínio cognitivo em idosos. | |
| IV | Ao comparar duas avaliações do mesmo paciente, é necessário saber o que mudou na prescrição entre elas. | |

<details>
<summary>Gabarito e comentário</summary>

**I — V.** É o achado do ensaio CATIE-AD. Consequência direta: **parte do declínio observado entre duas avaliações pode ser do fármaco**, e não da doença.

**II — F.** O efeito varia entre fármacos — em meta-análise em rede, o haloperidol teve o pior desempenho em todos os domínios. Anote **qual** antipsicótico, com dose e data de início; a classe não basta.

**III — V.**

**IV — V.** Sem isso, a curva que se lê como progressão pode ser farmacológica. É o mesmo raciocínio que a aula 02 aplicou à carga anticolinérgica e o que a aula 05 aplicará ao efeito de prática: **a medida tem história**.
</details>

---

## Questão 16 · estudo de caso · muito difícil
**Objetivo** interpretar um rastreio negativo sem encerrar a investigação.

> **Sr. Aparecido, 79 anos, DPOC e insuficiência cardíaca.**
> **História de vida.** Ex-metalúrgico, aposentou-se aos 58 pela doença pulmonar. Oito anos de escolaridade; fumou 40 anos, parou há 12. Cinquenta e quatro anos de casamento; dois filhos e quatro netos. Tinha oficina no quintal, onde consertava rádios e motores. Jogou futebol de várzea até os 60.
> **Encaminhamento.** Pela pneumologia, depois de dizer à médica "não vale mais a pena".
> **Quadro clínico.** Dispneia aos mínimos esforços; depende de oxigênio quase o dia inteiro. Duas internações por descompensação em doze meses. Dorme sentado, acorda várias vezes com falta de ar. Perdeu 5 kg — a nutricionista atribui à caquexia cardíaca.
> **Observação na sessão.** Funções cognitivas preservadas; atento, colaborativo, com iniciativa. Ri das piadas do neto e acompanha o campeonato. Nega tristeza persistente, anedonia e desesperança. Interrompe a testagem para tossir; falta de ar evidente em repouso. Repete que "queria era respirar".
> **GDS-15**, aplicada no ambulatório, com a esposa na sala de espera:

| Item | Resposta | Item | Resposta |
|---|---|---|---|
| 1. Satisfeito com a vida? | Sim | 9. Prefere ficar em casa? | Sim |
| 2. Interrompeu atividades? | Sim | 10. Mais problemas de memória? | Não |
| 3. Acha a vida vazia? | Não | 11. Maravilhoso estar vivo? | Sim |
| 4. Aborrece-se com frequência? | Não | 12. Vale a pena viver assim? | Sim |
| 5. De bem com a vida? | Sim | 13. Cheio de energia? | Não |
| 6. Teme que algo ruim aconteça? | Não | 14. Situação tem solução? | Sim |
...
## Questão 17 · múltipla escolha · muito difícil
**Objetivo** conhecer os limites de acurácia da GDS.
...
**Objetivo** integrar história, perfil cognitivo e funcionalidade num diferencial de dois quadros.

> **Dona Sebastiana, 76 anos, viúva, mora sozinha, 5 anos de escolaridade.**
> Há dez meses passou a acusar os vizinhos de entrarem em sua casa para "mexer nas coisas" e de falarem dela pela parede. O delírio é **estruturado e coerente**: ela nomeia os envolvidos, descreve horários, elaborou um esquema de trancas. Refere ouvir vozes que comentam suas ações. Nunca teve tratamento psiquiátrico.
> **Funcionalidade.** Continua administrando o próprio dinheiro, cozinha, toma a medicação sozinha e não se perde no bairro. Deixou de receber visitas, o que ela mesma atribui à desconfiança dos vizinhos.
> **Sensorial.** Perda auditiva não corrigida, referida pela filha há alguns anos.
> **Avaliação.** Rebaixamento discreto em memória de curto prazo; evocação tardia dentro do esperado para idade e escolaridade; sem alteração em nomeação ou praxia. Neuroimagem sem sinais de neurodegeneração.
...
| Psicose de início tardio / muito tardio | Sintomas psicóticos no transtorno neurocognitivo |
|---|---|
| delírio **estruturado**, sistematizado, frequentemente persecutório | delírio pouco estruturado e mutável, frequentemente de roubo ou de intrusão |
| mais alteração em memória de **curto prazo** | mais alteração em **evocação tardia** |
| funcionalidade preservada fora do âmbito do delírio | declínio funcional global |
| perfil cognitivo estático | perfil cognitivo progressivo |
| sem sinais de neurodegeneração à neuroimagem | atrofia ou lesão compatível |
